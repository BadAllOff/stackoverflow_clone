  ...
  context 'Any user' do
    ...
    context 'can use search' do
      ...
      scenario 'to find question' do
        ...
        select('Questions', from: 'search_query_condition')
        click_on 'Find'
      ...
      scenario 'to find answer' do
        ...
        select('Answers', from: 'search_query_condition')
        click_on 'Find'
      ...
      scenario 'to find comment' do
        ...
        select('Comments', from: 'search_query_condition')
        click_on 'Find'
      ...
      scenario 'to find user' do
        ...
        select('Users', from: 'search_query_condition')
        click_on 'Find'
